...
pub fn index(req: &mut Request) -> IronResult<Response> {
    ...
    if let Some(ser) = req.extensions.get::<PostgresConnection>()
        .log("PostgresConnection extension could not be found (teachers::index)")
...
pub fn show(req: &mut Request) -> IronResult<Response> {
    ...
    if let Some(ser) = extract_id(req)
        .and_then(|id| req.extensions.get::<PostgresConnection>()
            .log("PostgresConnection extension could not be found (teachers::show)")
...
pub fn edit(req: &mut Request) -> IronResult<Response> {
    if let Some(ser) = check_content_type(req)
        ...
        .and_then(|id| parse::<Teacher>(req)
            .and_then(|teacher| req.extensions.get::<PostgresConnection>()
                .log("PostgresConnection extension could not be found (teachers::edit)")
...
pub fn new(req: &mut Request) -> IronResult<Response> {
    if let Some(ser) = check_content_type(req)
        ...
        .and_then(|teacher| req.extensions.get::<PostgresConnection>()
            .log("PostgresConnection extension could not be found (teachers::new)")
...
pub fn delete(req: &mut Request) -> IronResult<Response> {
    if extract_id(req)
        .and_then(|id| req.extensions.get::<PostgresConnection>()
            .log("PostgresConnection extension could not be found (teachers::delete)")
